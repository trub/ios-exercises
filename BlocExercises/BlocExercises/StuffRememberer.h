...
@property (nonatomic, strong) NSMutableArray *arraySavedForLater;

@property (nonatomic, strong) NSMutableArray *arrayCopiedForLater;

@property (assign) CGFloat savedCgfloat;
